...
public class Agent implements Serializable {
	...
	public Agent(Long agId, String agName, int agType, String agAddress,
	...
	public Agent(String agName, int agType, String agAddress, String agPhone,
			String agEmail, String agPassport, String agWww, String agCountry,
			Date agDate, String agTag) {
		this(0L, agName, agType, agAddress, agPhone, agEmail, agPassport,
	...
	public String toString() {
		return "\nAgent [agId=" + agId + ", agName=" + agName + ", agType="
				+ agType + ", agAddress=" + agAddress + ", agPhone=" + agPhone
